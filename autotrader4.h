...
class AutoTrader : public ReadyTraderGo::BaseAutoTrader {
   ...
   private:
    ...
    unsigned long currAskEtf = 0;
    unsigned long currBidEtf = 0;
    signed long long currDiffToSellEtf = 0;
    signed long long currDiffToBuyEtf = 0;

    bool isDiffToSellRising = false;
    bool isDiffToBuyRising = false;
